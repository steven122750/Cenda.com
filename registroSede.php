...
<div class="container d-flex justify-content-center align-items-center vh-5 mt-3"> <!-- Centra vertical y horizontalmente el contenido -->
    ...
    <form class="container-form" action="guardarSede.php" method="POST">
        ...
        <div class="form-group">
            <input type="text" class="form-control custom-input" name="nombreSede" placeholder="Nombre de la sede" required>
        </div>
        <div class="form-group d-flex justify-content-center">
            <button type="submit" class="btn btn-primary btn-lg btn-block" name="guardarSede">Registrar sede</button>
        </div>
                ...
                <?php
                    ...
                    while ($row = mysqli_fetch_assoc($result)) { ?>
                        <tr>
                            ...
                            <td>
                            <a href="javascript:void(0);" class="btn btn-danger" onclick="confirmarEliminar(<?php echo $row['nombre']; ?>)">
